const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-CmqqnRgc-CrklXtL5.js","assets/app-D1y_3dFn.js"])))=>i.map(i=>d[i]);
var we=Object.getPrototypeOf;var ke=Reflect.get;var lt=(e,t,s)=>ke(we(e),s,t);import{U as b,V as Vt,W as E,X as Et,Y as C,Z as Ce,$ as G,a0 as S,a1 as Ae,a2 as De,a3 as Me,a4 as x,a5 as Wt,a6 as Oe,a7 as F,a8 as W,a9 as Ie,aa as Ht,ab as h,ac as Kt,ad as Pe,ae as _e,af as Qt,ag as U,ah as $t,ai as Ge,aj as Ut,j as Ne,ak as Be,al as Le,am as Fe,an as O,ao as Re,ap as Ve,aq as jt,ar as rt,as as Ee,at as We,au as He,av as Ke,aw as zt}from"./app-D1y_3dFn.js";import{A as I,T as Qe,D as Nt,x as l,s as Ue,$ as je,L as qt}from"./vidstack-D2YigfqZ-BLArkuQb.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const j={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},X=e=>(...t)=>({_$litDirective$:e,values:t});let gt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let pt=class extends gt{constructor(t){if(super(t),this.et=I,t.type!==j.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===I||t==null)return this.ft=void 0,this.et=t;if(t===Qe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const s=[t];return s.raw=s,this.ft={_$litType$:this.constructor.resultType,strings:s,values:[]}}};pt.directiveName="unsafeHTML",pt.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class mt extends pt{}mt.directiveName="unsafeSVG",mt.resultType=2;const ze=X(mt);/**
 * @license
 ...
 */const R=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const o of i)(n=(s=o)._$AO)===null||n===void 0||n.call(s,t,!1),R(o,t);return!0},z=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},Zt=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),ts(t)}};function Xe(e){this._$AN!==void 0?(z(this),this._$AM=e,Zt(this)):this._$AM=e}function Je(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let o=s;o<n.length;o++)R(n[o],!1),z(n[o]);else n!=null&&(R(n,!1),z(n));else R(this,e)}const ts=e=>{var t,s,n,i;e.type==j.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Je),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=Xe))};class Yt extends gt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),Zt(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(R(this,t),z(this))}setValue(t){if(qe(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}class es extends Yt{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===j.ATTRIBUTE||t.type===j.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Et(this.h)):I}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=C(this.l.bind(this)))}x(t){return this.w?bt(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function a(e){return X(es)(b(e))}class Xt{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=Vt(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});E(()=>t.disconnect()),E(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){Ce(t)?(s.textContent="",s.append(t)):(Nt(null,s),Nt(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}Ha(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=this._m.flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&this.La(this.elements)}}let ss=0,Q="data-slot-id";class Jt{constructor(t){this._m=t,this.Gc=Vt(this.Ha.bind(this)),this.slots=new Xt(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});E(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(Q);i||s.setAttribute(Q,i=++ss+"");for(const o of this.slots.elements){if(o.getAttribute("name")!==n||o.getAttribute(Q)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,o),o.setAttribute(Q,i)}}}}function ns({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return l`<svg
  ...
  `}function de(){const{audioGains:e}=d(),t=e();return O(t)?t[0]??0:t.min}function ue(){const{audioGains:e}=d(),t=e();return O(t)?t[t.length-1]??300:t.max}function Ws(){const{audioGains:e}=d(),t=e();return O(t)?t[1]-t[0]||25:t.step}function Hs(){return a(()=>{const{translations:e}=d(),{hasCaptions:t}=h(),s=u(e,"Off");return t()?l`
    ...
    `})}function Qs(){const{remote:e}=S(),{translations:t}=d(),s="Loop";return K({label:u(t,s),children:it({label:s,storageKey:"vds-player::user-loop",onChange(n,i){e.userPrefersLoopChange(n,i)}})})}function Us(){return a(()=>{const{translations:e}=d(),{canSetPlaybackRate:t,playbackRate:s}=h();return t()?k({label:u(e,"Speed"),value:a(()=>s()===1?T(e,"Normal"):s()+"x"),children:[nt({upIcon:"menu-speed-up",downIcon:"menu-speed-down",children:zs(),isMin:()=>s()===ce(),isMax:()=>s()===pe()})]}):null})}function ce(){const{playbackRates:e}=d(),t=e();return O(t)?t[0]??0:t.min}function pe(){const{playbackRates:e}=d(),t=e();return O(t)?t[t.length-1]??2:t.max}function js(){const{playbackRates:e}=d(),t=e();return O(t)?t[1]-t[0]||.25:t.step}function zs(){const{translations:e}=d(),t=u(e,"Speed"),s=ce,n=pe,i=js;return l`
    <media-speed-slider
