const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-H72EDyqs-D9Q-s9Cf.js","assets/app-yUPzM_G3.js"])))=>i.map(i=>d[i]);
var vs=Object.defineProperty;var fs=Object.getPrototypeOf;var hs=Reflect.get;var me=e=>{throw TypeError(e)};var $s=(e,t,s)=>t in e?vs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var P=(e,t,s)=>$s(e,typeof t!="symbol"?t+"":t,s),Gt=(e,t,s)=>t.has(e)||me("Cannot "+s);var v=(e,t,s)=>(Gt(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?me("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),D=(e,t,s,n)=>(Gt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),h=(e,t,s)=>(Gt(e,t,"access private method"),s);var Lt=(e,t,s)=>hs(fs(e),s,t);import{a7 as x,a8 as at,a9 as ge,aa as bs,ab as R,ac as C,ad as ye,ae as _,af as gs,ag as ys,ah as xs,ai as w,aj as xe,ak as Ss,al as Se,am as st,an as g,ao as ot,p as Ts,ap as ws,aq as Te,ar as ks,as as Cs,at as As,au as we,av as bt,aw as Yt,ax as Ds,ay as ke,az as Ms,aA as Is,aB as Os,aC as V,aD as Ps,aE as _s,aF as Ce,aG as Nt,aH as Gs,aI as Ls,aJ as Ns,aK as Bs,aL as Ae}from"./app-yUPzM_G3.js";import{A as E,T as Fs,D as ve,x as l,s as Vs,$ as Rs,L as De}from"./vidstack-CwTj4H1w-Bp4ARBvF.js";/**
 * @license
  ...
  `}function Un(){return a(()=>{const{live:e,duration:t}=g();return e()?Ee():t()?l`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function Ye(){return a(()=>{const{live:e}=g();return e()?Ee():Qn()})}function Ze(){return a(()=>{const{textTracks:e}=C(),{title:t,started:s}=g(),n=w(null);return we(e,"chapters",n.set),n()&&(s()||!t())?Je():l`<media-title class="vds-chapter-title"></media-title>`})}function Je(){return l`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class Xe extends Js{async loadIcons(){const t=(await Ts(async()=>{const{icons:n}=await import("./vidstack-H72EDyqs-D9Q-s9Cf.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=Ys({name:n,paths:t[n]});return s}}var F;let zn=(F=class extends Ct{},P(F,"props",{...Lt(F,F,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576}),F);function qn(){return[Xt(),ne(),l`
    ...
    `]}function jn(){return a(()=>{let e=w(void 0),t=w(!1),s=C(),{title:n,started:i,currentTime:o,ended:r}=g(),{translations:p}=u(),c=Ls(e),y=()=>i()||o()>0;const f=()=>{const S=r()?"Replay":y()?"Continue":"Play";return`${k(p,S)}: ${n()}`};_(()=>{var S;c()&&document.activeElement===document.body&&((S=s.player.el)==null||S.focus({preventScroll:!0}))});function m(){const S=e(),T=!!S&&!c()&&S.clientWidth<S.children[0].clientWidth;S&&Ns(S,"vds-marquee",T),t.set(T)}function $(){return l`
      ...
      `}return ke(e,m),n()?l`
        ...
        `:L()})}function Yn(){const e="top end";return[He({tooltip:"top",placement:e,portal:!0}),je({tooltip:"top end",placement:e,portal:!0})]}var mt,Z,A,ts,es,ss,ns,is,as;class zt extends Ce(De,zn){constructor(){super(...arguments);b(this,A);b(this,mt);b(this,Z,w(!1))}onSetup(){this.forwardKeepAlive=!1,D(this,mt,C()),this.classList.add("vds-audio-layout"),h(this,A,ss).call(this)}onConnect(){Fe("audio",()=>this.isMatch),h(this,A,es).call(this)}render(){return a(h(this,A,ts).bind(this))}}mt=new WeakMap,Z=new WeakMap,A=new WeakSet,ts=function(){return this.isMatch?qn():null},es=function(){const{menuPortal:s}=u();_(()=>{if(!this.isMatch)return;const n=Ke(this,this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),i=n?[this,n]:[this];return(this.$props.customIcons()?new Ge(i):new Xe(i)).connect(),s.set(n),()=>{n.remove(),s.set(null)}})},ss=function(){const{pointer:s}=v(this,mt).$state;_(()=>{s()==="coarse"&&_(h(this,A,ns).bind(this))})},ns=function(){if(!v(this,Z).call(this)){Nt(this,"pointerdown",h(this,A,is).bind(this),{capture:!0});return}Nt(this,"pointerdown",s=>s.stopPropagation()),Nt(window,"pointerdown",h(this,A,as).bind(this))},is=function(s){const{target:n}=s;Gs(n)&&n.closest(".vds-time-slider")&&(s.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),v(this,Z).set(!0))},as=function(){v(this,Z).set(!1),this.removeAttribute("data-scrubbing")},P(zt,"tagName","media-audio-layout"),P(zt,"attrs",{smallWhen:{converter(s){return s!=="never"&&!!s}}});/**
 * @license
